...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
        {/* Hero Section */}
        <section className="container mx-auto px-4 pt-20 pb-16 text-center">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              ...
              >
                <SparklesIcon className="w-16 h-16 text-blue-600 dark:text-blue-400 mr-4" />
              </motion.div>
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-slate-700 dark:text-slate-200 max-w-3xl mx-auto mb-8"
          >
          ...
          >
            <Link
              href="/app"
              className="px-10 py-4 rounded-full bg-gradient-to-r from-blue-600 to-purple-500 text-white font-bold shadow-xl hover:scale-105 transition-transform text-xl flex items-center gap-3"
            >
            ...
            <a
              ...
              className="px-10 py-4 rounded-full bg-white/90 dark:bg-slate-800/90 text-slate-700 dark:text-slate-200 font-bold shadow-xl border border-slate-200 dark:border-slate-700 hover:scale-105 transition-transform text-xl flex items-center gap-3"
            >
          ...
          >
            {features.map((f, i) => (
              <motion.div
                ...
                className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-slate-200 dark:border-slate-700 text-center"
              >
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          ...
          >
            ...
            <Link
              href="https://github.com/udaypankhaniya/diff-check"
              className="inline-flex items-center gap-3 px-12 py-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-full shadow-2xl hover:scale-105 transition-all duration-300 text-xl"
            >
